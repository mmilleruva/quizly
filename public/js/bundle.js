...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n  ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.isCorrect), {hash:{},inverse:self.program(2, program2, data),fn:self.program(2, program2, data),data:data});
...
function program2(depth0,data) {
  ...
  buffer += "<h2>Question</h2>\n<p>";
  if (helper = helpers.prompt) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.prompt); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</p>\n<form>\n  <br/>\n  <label for=\"response\">Response:</label>\n  <input type=\"text\" class=\"js-response\" name=\"response\" required\n    placeholder=\"Response\" value=\"";
  ...
  buffer += escapeExpression(stack1)
    + "\">\n  <button class=\"btn btn-xlarge btn-primary js-submit\">Submit</button>\n</form>\n\n";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.response), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n\n\n";
  return buffer;
  });
